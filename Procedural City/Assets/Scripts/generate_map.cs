                ...
                foreach (int[] i in coords)
                {
                    ...
                    for (int h = 0; h < cityHeight; h++)
                    {
                        for (int w = 0; w < cityWidth; w++)
                        {
                            ...
                            {
                                if (result < 2)
                                    Instantiate(buildings[0], position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
                                else if (result < 4)
                                    Instantiate(buildings[1], position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
                                else if (result < 6)
                                    Instantiate(buildings[2], position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
                                else if (result < 8)
                                    Instantiate(buildings[3], position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
                                else if (result < 10)
                                    Instantiate(buildings[4], position, Quaternion.Euler(0.0f, 0.0f, 0.0f));
                            }
                        }
                    }
                }
